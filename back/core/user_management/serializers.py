...
class UserUpdateTwoFactorAuthSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        elif validated_data.get('TwoFactorAuth') == False:
...
class UserListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomUser
        fields = ('username', 'status', 'profile_picture', 'TwoFactorAuth', 'wins', 'losses', 'elo', 'wins_pool', 'losses_pool', 'elo_pool', 'friends', 'friend_requests')